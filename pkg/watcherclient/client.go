...
type libraryClient struct {
	fetcherClient watcher.FetcherClient
...
func NewLibraryClient(opts metricsprovider.MetricsProviderOpts) (watcher.Client, error) {
	var err error
	...
	client.watcher.StartWatching(false)
	return client, nil
}

func NewServiceClient(watcherAddress string) (watcher.Client, error) {
